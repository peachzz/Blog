...
#define OS_TICKS_PER_SEC       1000u//100u   /* Set the number of ticks in one second                        */
...
#define OS_MBOX_QUERY_EN          1u   /*     Include code for OSMboxQuery()                           */
                                       ...
                                       /* --------------------- MEMORY MANAGEMENT -------------------- */
#define OS_MEM_EN                 1u//0u   /* Enable (1) or Disable (0) code generation for MEMORY MANAGER */
