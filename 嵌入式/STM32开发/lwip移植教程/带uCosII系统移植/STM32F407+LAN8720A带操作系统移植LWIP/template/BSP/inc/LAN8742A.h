...
/* ETH_RMII_RESET */
#define ETH_RMII_RESET_GPIO_CLK          RCC_AHB1Periph_GPIOC
#define ETH_RMII_RESET_PORT              GPIOC
#define ETH_RMII_RESET_PIN               GPIO_Pin_2
#define ETH_RMII_RESET_AF                GPIO_AF_ETH
#define ETH_RMII_RESET_SOURCE            GPIO_PinSource2
