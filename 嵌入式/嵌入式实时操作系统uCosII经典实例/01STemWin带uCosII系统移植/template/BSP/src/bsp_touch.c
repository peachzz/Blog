...
//    LCD_DispString_EN(50,120,"Touch Calibrate...",BACKGROUND,BLUE,FONT_24);	
//    LCD_DispChar_EN(150, 80, i+'1',BACKGROUND,RED,FONT_24);
    GUI_DispStringAt("Touch Calibrate...",50,120);
    GUI_DispStringAt((char *)(i+'1'),150, 80);
    /* 适当的延时很有必要 */        
...
//	  printf("after Calibration x = %d y=%d\n\r",usTest_x,usTest_y);
    ...
    {
      LCD_Clear(0, 0,LCD_DEFAULT_WIDTH, LCD_DEFAULT_HEIGTH, BACKGROUND);   
//      LCD_DispString_EN(80,100,"Calibrate fail",BACKGROUND,RED,FONT_24);
//      LCD_DispString_EN(110,130,"try again",BACKGROUND,RED,FONT_16);
      GUI_DispStringAt("Calibrate fail",80,100);
      GUI_DispStringAt("try again",110,130);
  ...
  LCD_Clear(0, 0,LCD_DEFAULT_WIDTH, LCD_DEFAULT_HEIGTH, BACKGROUND); 
//  LCD_DispString_EN(50,100,"Calibrate Succed",BACKGROUND,BLUE,FONT_24);
  GUI_DispStringAt("Calibrate Succed",50,100);
  XPT2046_DelayUS(1000000); 
  LCD_Clear(0, 0,LCD_DEFAULT_WIDTH, LCD_DEFAULT_HEIGTH, BACKGROUND); 
  return 0;    
}
