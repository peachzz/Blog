...
//#define ENC28J60_RST 	PEout(1)	//MiniSTM32开发板上ENC28J60复位引脚
//#define ENC28J60_CS  	PAout(4)	//MiniSTM32开发板ENC28J60片选引脚
//#define ENC28J60_INT	PAin(1)		//MiniSTM32开发板ENC28J60中断引脚
#define ENC28J60_CS(x)  ((x)?(GPIO_SetBits(GPIOA,GPIO_Pin_4)):GPIO_ResetBits(GPIOA,GPIO_Pin_4))
#define ENC28J60_RST(x) ((x)?(GPIO_SetBits(GPIOE,GPIO_Pin_1)):GPIO_ResetBits(GPIOE,GPIO_Pin_1))
#define ENC28J60_INT     GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_1)
